                    ...
                    <form action="{{ route('destinations.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="category" name="category" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                ...
                                <option value="taman nasional" {{ old('category') == 'taman nasional' ? 'selected' : '' }}>Taman Nasional</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="image_url" type="url" name="image_url" value="{{ old('image_url') }}" placeholder="https://..." 
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            @error('image_url')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
